...
export const AuthModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        className="absolute inset-0 bg-black/80 dark:bg-white/10 backdrop-blur-sm"
        onClick={onClose}
      >
        <button
          onClick={onClose}
          className="absolute top-10 right-10 text-gray-400 hover:text-white transition-colors cursor-pointer"
        >
          <svg
      ...
      <div
        ...
        className="z-60 relative w-120 inset-0 flex items-center justify-center p-4"
      >
        <div className="relative z-10 w-full max-w-md  rounded-2xl p-8 bg-black/80 shadow-xl">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 p-4 dark:bg-white/10 dark:hover:bg-[#16a084]/20 backdrop-blur-md border border-white/20 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#16a084]/20 group"
            >
